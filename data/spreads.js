// 塔罗牌阵定义
// 匹配优先级: yes-no → 单张 → 三牌阵(时间流/身心灵/圣三角/二选一) → 六芒星 → 凯尔特十字
...
var spreads = [
  ...
  },
  {
    ...
    description: '当面临两个方向举棋不定时，帮你分别看清两条路的结局。',
    positions: [
      { name: '现状', meaning: '你当前的真实处境' },
      { name: '选项A', meaning: '选择A的可能结果' },
      { name: '选项B', meaning: '选择B的可能结果' }
    ]
  },
  ...
  // ==================== 7 张牌 ====================
  {
    ...
    card_count: 7,
    priority: 4,
    suitable_for: ['关系', '人际', '双方', '伴侣', '感情', '情感', '爱情', '恋爱', '喜欢', '暗恋', '朋友', '合作', '分手', '复合', '婚姻'],
    description: '专门探索人与人之间关系的深层牌阵，从七个角度全面揭示双方连接的真相。',
    positions: [
  ...
  // ==================== 10 张牌 ====================
  {
    ...
    card_count: 10,
    priority: 5,
    suitable_for: ['全面', '综合', '深入', '全貌', '人生', '事业', '工作', '职业', '发展', '命运', '整体'],
